  ...
  <div className="content-section">
    <div className="row">
      <div className="col-md-7">
        <h1 className="mb-3">Giới thiệu BANKING APP Mini Banking</h1>
        <p className="text-muted mb-3">
          <strong>BANKING APP Mini Banking</strong> là hệ thống ngân hàng số mô phỏng, dùng để demo các luồng
        ...
        <h5 className="mb-2">Bạn có thể làm gì với BANKING APP?</h5>
