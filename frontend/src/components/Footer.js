...
const Footer = () => {
  ...
  return (
    <footer className="site-footer mt-4 bg-header-footer text-white py-4">
      <div className="container">
        <div className="row py-2 py-md-3">
          <div className="col-12 col-md-4 mb-3 mb-md-0">
            <h5 className="footer-brand mb-2">BAKING APP</h5>
          ...
          <div className="col-12 col-md-4">
            ...
            <ul className="list-unstyled footer-contact">
              ...
              <li className="mb-1">
                ...
                <a href="mailto:support @baking.app.vn" className="text-muted small">support @baking.app.vn</a>
              </li>
              <li>
